...
// • Start with your program from Exercise 15. Add a print statement to the end of your program informing people that you found a bigger dinner table.
//                                                                         
let GuestList: string[] = ["Sehrish", "Ifrah", "Saira", "Anabiya"];         //printing message to each person by using for loop..
...
let Guest_List: string[] = ["Sehrish", "Ifrah", "Saira", "Anabiya"];
...
// • Use append() to add one new guest to the end of your list.
 let friends : string[] =["Rania","warda","Amna","Rabiya"];
...
// part 3
// • Print a new set of invitation messages, one for each person in your list.
let Girls:string[] = ["Amal","Afshan","Humaira","Maria","Anamika","Hoorain"]
