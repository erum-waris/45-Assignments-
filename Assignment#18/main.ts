...
let placeToVisit :string[] = [ "Skardu" , "NathiaGali" , "Switzerland" , "Makkah" , "Madina" ];
console.log("Original array :" ,placeToVisit);

// part ( 2 )
// • Print your array in alphabetical order without modifying the actual list.

let places : string[] = placeToVisit.slice().sort()
...
let reverseOrder : string[] = placeToVisit.slice().sort().reverse()
...
// • Reverse the order of your list again. Print the list to show it’s back to its original order.
 ...
 let reverseList : string[] = placeToVisit.reverse()
