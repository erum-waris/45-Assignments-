...
let Guest_list : string[] =["Kanwal","Huma", "Fatima", "Uroosa"];
for (let i=0; i < Guest_list.length; i++)                               
   {                                                                    //for loop is using for printing to each Guest
...
let Guest_list1  :string[] = ['Kanwal','Huma','Hina','Fatima','Uroosa'];
...
// Fourth n part
// • Print a second set of invitation messages, one for each person who is still in your list/.
let newGuestList  :string[] = ['Kanwal','Huma','Uroosa','Fatima','Erum'];
